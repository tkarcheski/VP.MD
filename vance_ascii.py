...
Usage:
    python3 vance_ascii.py youtube --url https://youtube.com/shorts/S2GC9PxDWPI
    python3 vance_ascii.py generate --frames 30 --ai
    python3 vance_ascii.py ascii --text "VANCE IS DANCING"
    python3 vance_ascii.py play frames/ --fps 12 --loop
...
def main():
    ...
    if args.command == "youtube":
        ...
        print("Usage: python3 vance_ascii.py {youtube,generate,ascii,play} ...", file=sys.stderr)
        sys.exit(1)
